...
add_arg('data_dir',         str,   '/media/airobot/docs/coco',        "The data root path.")
add_arg('test_list',        str,   '/media/airobot/docs/coco/annotations/instances_val2017.json',        "The testing data lists.")
