...
def eval(args, data_args, configs, val_file_list):
	...
	fluid.io.save_inference_model(model_save_dir+"_inference", [image.name],
								  [bboxes, scores], exe, test_prog)
...
if __name__ == '__main__':
	...
	if args.mode == 'train':
		train(args, data_args, train_parameters[dataset], train_file_list, val_file_list)

	elif args.mode == 'test':
		eval(args, data_args, train_parameters[dataset], val_file_list)
	else:
