...
add_arg('test_list',        str,   'annotations/instances_val2017.json',        "The testing data lists.")
...
def eval(args, data_args, test_list, batch_size, model_dir=None):
    ...
    def test():
        ...
        print(os.path.join(data_args.data_dir, test_list))
